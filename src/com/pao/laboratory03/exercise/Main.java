      ...
      try {
        switch (option) {
          ...
          case "2":
            ...
            System.out.print("Materie (" + String.join(", ",
                java.util.Arrays.stream(Subject.values()).map(Enum::name).toArray(String[]::new)) + "): ");
          ...
          case "5":
            ...
            service.getAveragePerSubject()
                .forEach((subj, avg) -> System.out.println(subj.name() + ": " + String.format("%.2f", avg)));
            break;
